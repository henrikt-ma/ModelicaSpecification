...
The optional \lstinline[language=grammar]!unit-exponent! immediately following the \lstinline[language=grammar]!unit-operand! supports both integer and rational exponents.
