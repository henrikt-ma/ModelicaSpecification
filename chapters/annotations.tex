...
record Curve
  ...
  /*literal*/ constant String yAxis "Associated y axis";
...
A curve's associated $y$ axis is defined by \lstinline!yAxis!.
Valid values are the strings \lstinline!"left"! and \lstinline!"right"!.
