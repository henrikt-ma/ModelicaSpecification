...
The derivative function is only valid if \lstinline!inputVar1! (and \lstinline!inputVar2! etc.) are independent of the variables the function call is differentiated with respect to (i.e. that the derivative of \lstinline!inputVar1! is ``zero'').
The derivative of \lstinline!inputVar1! (and \lstinline!inputVar2! etc.) are excluded from the argument list of the derivative-function.
...
The derivative of \lstinline!inputVar1! is excluded from the argument list of the derivative-function.
...
ModelicaAllocateString (see \autoref{utility-functions}) {[}\emph{It is not suitable
